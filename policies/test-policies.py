...
def main(argv):
    ...
    q = policies_module.create_qualifier(afc_host, token, 'my-qualifier1', vlans='100')
    p = policies_module.create_qos_policy(afc_host, token, 'my-policy1', 5, 5, [q])
